...
This will essentially run a GWAS 1000 times and it will take all p-values from those tests that are less than `1e-3`. We will not end up needing all 1.65 million p-values that come with each association test and so this lowers the computational burden on the computer. 
